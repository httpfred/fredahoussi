...
const App = () => {
  ...
  const scrollWords = [
    'design.', 'prototype.', 'solve.', 'build.', 'develop.',
    'debug.', 'learn.', 'create.', 'innovate.',
    'optimize.', 'transform.', 'inspire.', 'coding.'
  ];
      ...
      <div className="relative z-10">
        ...
        <header className="min-h-screen flex flex-col justify-center items-start px-8 md:px-20 relative">
          ...
          {/* <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60">
            <span className="text-sm text-white dark:text-black">scroll</span>
            <svg className="w-6 h-6 animate-bounce text-white dark:text-black" viewBox="0 0 24 24" fill="none">
        ...
        <main>
          ...
          <section className={`min-h-screen flex px-8 md:px-20 ${snap ? 'scroll-snap-y' : ''}`}>
            <h2 className="sticky top-[calc(50%-0.5lh)] h-fit font-semibold text-4xl md:text-6xl text-white dark:text-black">
              <span aria-hidden="true">Open for&nbsp;</span>
