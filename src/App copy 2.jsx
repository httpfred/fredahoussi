  ...
  const workExperiences = [
    {
      ...
      period: '2023 - Present',
      description: 'Leading the frontend development team, architecting React applications, and implementing modern UI/UX solutions.',
    ...
    },
    {
      ...
      period: '2021 - 2023',
      description: 'Developed and maintained multiple client projects, from e-commerce sites to complex web applications.',
      achievements: ['Delivered 15+ client projects', 'Improved SEO by 60%', 'Mentored junior developers'],
      logo: '🎯'
    },
    {
      id: 3,
      ...
      period: '2020 - 2021',
      description: 'Started as a junior developer, quickly progressed to handling independent projects and client communications.',
      achievements: ['Built 5 production apps', 'Implemented responsive designs', 'Received "Rookie of the Year" award'],
      logo: '🚀'
    }
  ];
    ...
    <div className={`min-h-screen transition-colors duration-300 relative ${theme === 'dark' ? 'dark' : ''}`}>
      ...
      <div className="relative z-10">
        ...
        <header className="min-h-screen flex flex-col justify-center items-start px-8 md:px-20 relative">
          ...
          >
            Fred Ahoussi<br />developer.
          </h1>
        </header>

        <main>
          {/* Scroll Words Section with Dynamic Illustration */}
          <section className={`min-h-screen flex items-center px-8 md:px-20 ${snap ? 'scroll-snap-y' : ''}`}>
            <div className="flex flex-col md:flex-row gap-8 w-full">
              <div className="flex-1">
                <h2 className="text-4xl md:text-6xl text-white dark:text-black font-bold mb-8">
                  Open for&nbsp;
                </h2>
                <ul className="list-none font-semibold text-xl md:text-2xl">
              ...
              <div className="flex-1 flex items-center justify-center min-h-[300px] bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
                <div className="text-center">
                  <div className="text-9xl mb-4 animate-float">
                    {scrollWords[activeWordIndex]?.illustration || '🎨'}
                  </div>
                  <p className="text-white/60 text-sm">
                    Currently focused on {scrollWords[activeWordIndex]?.text || 'design'}
                  </p>
                </div>
              </div>
            </div>
